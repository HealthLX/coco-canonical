<xsl:stylesheet xpath-default-namespace="http://cocodata.org" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="PRAC" select="/clinicals/clinical/practitioners_roles/practitioner_role"/>
    <xsl:variable name="Endpoint" select="$PRAC/endpoints"/>
    <xsl:variable name="ORG" select="$PRAC/clinical/organizations/organization"/>
                ...
                <Endpoint xmlns="http://hl7.org/fhir">
                    <id>
                        <xsl:attribute name="value">
                            ...
                            <xsl:value-of
                                select="concat($CUSTOMER_PREFIX, '-', $PRAC/unique_identifier, ./identifier/value,./connectionType/code)"
                            />
                        </xsl:attribute>
                    </id>
