    ...
    <xsl:template match="*">
     ...
     <!--       <xsl:choose>
            ...
            <class>
                <type>
                    <coding>
                        <system value="http://data.healthlx.com/CodeSystem/coverage-class"/>
                        <code value="policy number"/>
                    </coding>
                </type>
                <value>
                    <xsl:attribute name="value">
            ...
            <class>
                ...
                <value>
                    <xsl:attribute name="value">
                        <xsl:value-of select="$PTT_MEMBER_DEMOGRAPHICS/health_coverage/plan_name"/>
                    </xsl:attribute>
               </value>
             </class>
            <order value="1"/>
