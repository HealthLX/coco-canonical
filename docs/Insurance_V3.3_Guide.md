...
# Insurance_V3.3 Implementation Guide

**HLX0123 HLX Insurance_V3.3 IG (XSD_V3.3)**
...
7. [Required Elements of Insurance_V3.3 XSD](#required-elements-of-insurance_v3.3-xsd)
8. [All Elements of Insurance_V3.3 XSD](#all-elements-of-insurance_v3.3-xsd)
...
This implementation guide provides field mappings and requirements for HealthLX Insurance_V3.3 data submissions in XML format based on FHIR R4 standards. XML format enables structured data exchange with built-in validation against the provided XSD schema.
...
| time | xs:time | – | ([01][0-9]\|2[0-3]):[0-5][0-9]:([0-5][0-9]\|60)(\.[0-9]+)? |
| dateTime | xs:dateTime | – | ([0-9]([0-9]([0-9][1-9]\|[1-9]0)\|[1-9]00)\|[1-9]000)(-(0[1-9]\|1[0-2])(-(0[1-9]\|[1-2][0-9]\|3[0-1])(T([01][0-9]\|2[0-3]):[0-5][0-9]:([0-5][0-9]\|60)(\.[0-9]+)?(Z\|(\+\|-)((0[0-9]\|1[0-3]):[0-5][0-9]\|14:00)))?)?)? |
| date | xs:date | – | ([0-9]([0-9]([0-9][1-9]\|[1-9]0)\|[1-9]00)\|[1-9]000)(-(0[1-9]\|1[0-2])(-(0[1-9]\|[1-2][0-9]\|3[0-1]))?)? |
...
| rank | unsignedInt | 0 | 1 | Specify preferred order of use (1 = highest) |
...
<h2 style="color:#E60073">Required Elements of Insurance_V3.3 XSD</h2>
...
<h2 style="color:#E60073">All Elements of Insurance_V3.3 XSD</h2>
...
| name | contact | 0..1 | A name associated with the contact | – | string |
...
Insurance_V3.3 files should be submitted according to the schedule agreed upon with HealthLX. Typical submission frequencies include daily, weekly, or monthly updates.
