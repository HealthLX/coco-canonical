...
# Provider Directory_V4.2 Implementation Guide

**HLX0123 HLX Provider Directory_V4.2 IG (XSD_V4.2)**
...
7. [Required Elements of Provider Directory_V4.2 XSD](#required-elements-of-provider-directory_v4.2-xsd)
8. [All Elements of Provider Directory_V4.2 XSD](#all-elements-of-provider-directory_v4.2-xsd)
...
This implementation guide provides field mappings and requirements for HealthLX Provider Directory_V4.2 data submissions in XML format based on FHIR R4 standards. XML format enables structured data exchange with built-in validation against the provided XSD schema.
...
| schema_version | xs:decimal | This element defines what version of the roster schema you will be validating against (e.g. 1.0) | ([1-9]{1,2})\.([0-9]{1,2}) |
...
<h3 style="color:#E60073">names</h3>
...
<h3 style="color:#E60073">telecoms</h3>
...
<h3 style="color:#E60073">addresses</h3>
...
<h3 style="color:#E60073">qualifications</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| qualification | qualification | 0 | unbounded | – |
...
<h3 style="color:#E60073">communications</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| communications | languages | 0 | unbounded | – |
...
<h3 style="color:#E60073">codes</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| code | – | 0 | unbounded | This element is used to indicate the role of a Practitioner. The full list can be found here: https://build.fhir.org/ig/HL7/davinci-pdex-plan-net/ValueSet-PractitionerRoleVS.html |
| code | role | 0 | 1 | – |
| display | string | 0 | 1 | – |
...
<h3 style="color:#E60073">available_times</h3>
...
<h3 style="color:#E60073">not_availables</h3>
...
<h3 style="color:#E60073">new_patients_list</h3>
...
<h3 style="color:#E60073">types</h3>
...
<h3 style="color:#E60073">aliases</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| alias | string | 0 | unbounded | A list of alternate names that the organization is known as, or was known as in the past |
...
<h3 style="color:#E60073">contact</h3>
...
<h3 style="color:#E60073">contacts</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| contact | contact | 0 | unbounded | – |
...
| gender | – | 0 | 1 | – |
| birth_date | date | 0 | 1 | – |
| qualifications | qualifications | 0 | 1 | – |
| communications | communications | 0 | 1 | – |
| period | period | 0 | 1 | – |
| affiliated_organization | organization | 0 | 1 | – |
| codes | codes | 0 | 1 | – |
| specialties | practitioner_specialties | 0 | 1 | – |
| available_times | available_times | 0 | 1 | – |
| not_availables | not_availables | 0 | 1 | – |
| availability_exceptions | string | 0 | 1 | – |
| new_patients_list | new_patients_list | 0 | 1 | – |
| networks | networks | 1 | 1 | – |
| locations | locations | 0 | 1 | – |
| healthcare_services | healthcare_services | 0 | 1 | – |
...
<h3 style="color:#E60073">providing_organization</h3>
...
<h3 style="color:#E60073">provider</h3>

<div class = "heatMap">

| Field Name | Type | MinOccurs | MaxOccurs | Description |
| --- | --- | --- | --- | --- |
| practitioner | practitioner | 1 | unbounded | – |
| providing_organization | providing_organization | 1 | unbounded | – |
...
<h2 style="color:#E60073">Required Elements of Provider Directory_V4.2 XSD</h2>
...
| --- | --- | --- | --- | --- | --- |
| providers |  | 1..1 | – | – | – |
| schema_version | providers | 1..1 | – | – | schema_version |
...
| provider | providers | 1..unbounded | – | – | provider |
...
<h2 style="color:#E60073">All Elements of Provider Directory_V4.2 XSD</h2>
...
Provider Directory_V4.2 files should be submitted according to the schedule agreed upon with HealthLX. Typical submission frequencies include daily, weekly, or monthly updates.
